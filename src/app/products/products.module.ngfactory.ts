...
import * as import1 from './products.module';
...
import * as import28 from './backend/products/products.actions';
import * as import29 from '@angular/core/src/di/injector';
import * as import30 from './products-page/products-page.component.ngfactory';
import * as import31 from './new-product-page/new-product-page.component.ngfactory';
import * as import32 from './edit-product-page/edit-product-page.component.ngfactory';
...
import * as import38 from '../settings';
import * as import39 from './products-page/products-page.component';
import * as import40 from './new-product-page/new-product-page.component';
import * as import41 from './edit-product-page/edit-product-page.component';
import * as import42 from '../core/rest.service';
...
class ProductsModuleInjector extends import0.NgModuleInjector<import1.ProductsModule> {
  ...
  _ProductsModule_9:import1.ProductsModule;
  __LOCALE_ID_10:any;
  ...
  __ROUTES_43:any[];
  __ProductsActions_44:import28.ProductsActions;
  constructor(parent:import29.Injector) {
    super(parent,[
      import30.ProductsPageComponentNgFactory,
      import31.NewProductPageComponentNgFactory,
      import32.EditProductPageComponentNgFactory
    ]
    ,([] as any[]));
  }
  ...
  get _APP_ID_18():any {
    if ((this.__APP_ID_18 == (null as any))) { (this.__APP_ID_18 = import33._appIdRandomProviderFactory()); }
  ...
  get _EventManager_22():import16.EventManager {
    if ((this.__EventManager_22 == (null as any))) { (this.__EventManager_22 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_21,this.parent.get(import36.NgZone))); }
  ...
  get _RootRenderer_26():any {
    if ((this.__RootRenderer_26 == (null as any))) { (this.__RootRenderer_26 = import37._createConditionalRootRenderer(this._DomRootRenderer_25,this.parent.get(import37.NgProbeToken,(null as any)))); }
  ...
  get _APP_SETTINGS_42():any {
    if ((this.__APP_SETTINGS_42 == (null as any))) { (this.__APP_SETTINGS_42 = import38.settings); }
  ...
  get _ROUTES_43():any[] {
      if ((this.__ROUTES_43 == (null as any))) { (this.__ROUTES_43 = [[
        {
          path: 'products',
          component: import39.ProductsPageComponent
        }
        ,
        {
          path: 'products/new',
          component: import40.NewProductPageComponent
        }
        ,
        {
          path: 'products/:id',
          component: import41.EditProductPageComponent
        }
  ...
  get _ProductsActions_44():import28.ProductsActions {
    if ((this.__ProductsActions_44 == (null as any))) { (this.__ProductsActions_44 = new import28.ProductsActions(this.parent.get(import42.RestService))); }
    return this.__ProductsActions_44;
  }
  createInternal():import1.ProductsModule {
    ...
    this._ProductsModule_9 = new import1.ProductsModule();
    ...
    this._Testability_14 = new import12.Testability(this.parent.get(import36.NgZone));
    this._ApplicationRef__15 = new import13.ApplicationRef_(this.parent.get(import36.NgZone),this.parent.get(import43.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_13,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_14);
    return this._ProductsModule_9;
  }
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.ProductsModule)) { return this._ProductsModule_9; }
    if ((token === import44.LOCALE_ID)) { return this._LOCALE_ID_10; }
    if ((token === import10.NgLocalization)) { return this._NgLocalization_11; }
    if ((token === import45.ErrorHandler)) { return this._ErrorHandler_12; }
    ...
    if ((token === import46.DOCUMENT)) { return this._DOCUMENT_19; }
    ...
    if ((token === import47.AnimationDriver)) { return this._AnimationDriver_24; }
    if ((token === import18.DomRootRenderer)) { return this._DomRootRenderer_25; }
    if ((token === import48.RootRenderer)) { return this._RootRenderer_26; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_27; }
    if ((token === import49.Sanitizer)) { return this._Sanitizer_28; }
    if ((token === import20.ViewUtils)) { return this._ViewUtils_29; }
    if ((token === import50.IterableDiffers)) { return this._IterableDiffers_30; }
    if ((token === import51.KeyValueDiffers)) { return this._KeyValueDiffers_31; }
    ...
    if ((token === import52.XSRFStrategy)) { return this._XSRFStrategy_38; }
    if ((token === import26.XHRBackend)) { return this._XHRBackend_39; }
    if ((token === import27.RequestOptions)) { return this._RequestOptions_40; }
    if ((token === import53.Http)) { return this._Http_41; }
    if ((token === import38.APP_SETTINGS)) { return this._APP_SETTINGS_42; }
    if ((token === import54.ROUTES)) { return this._ROUTES_43; }
    if ((token === import28.ProductsActions)) { return this._ProductsActions_44; }
